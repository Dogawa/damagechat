...
import com.rdc.damage.util.DimenUtils;
...
public class PaletteView extends View {
    ...
    public interface Callback {
        ...
        void onPassTouchEvent(float x, float y, int action);
    }
    ...
    public boolean dispatchTouchEvent(float x, float y, int action) {
        if(!isEnabled()){
            return false;
        }
        switch (action) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        mCallback.onPassTouchEvent(x,y,action);
        return dispatchTouchEvent(x, y, action);
    }
}
